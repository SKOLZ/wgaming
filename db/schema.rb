...
ActiveRecord::Schema.define(version: 20150806033609) do
  ...
  add_index "events_games", ["event_id", "game_id"], name: "index_events_games_on_event_id_and_game_id", using: :btree
  add_index "events_games", ["game_id", "event_id"], name: "index_events_games_on_game_id_and_event_id", using: :btree
